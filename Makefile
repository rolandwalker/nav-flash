...
TEST_DEP_2=pulse
TEST_DEP_2_STABLE_URL=http://git.savannah.gnu.org/cgit/emacs.git/plain/lisp/cedet/pulse.el?h=emacs-24.3
TEST_DEP_2_LATEST_URL=http://git.savannah.gnu.org/cgit/emacs.git/plain/lisp/cedet/pulse.el?h=master
